...
// case class HashTabCmd (conf: HashTableConfig) extends Bundle {
...
// case class DRAMRdCmd(conf: HashTableConfig) extends Bundle {
//   val memOffs = UInt(64 bits)
//   val nEntry = UInt(conf.bucketOffsWidth bits)
// }

// case class DRAMWrCmd(conf: HashTableConfig) extends Bundle {
//   val memOffs = UInt(64 bits) // hash entry offset in DRAM
//   val ptrVal = UInt(conf.ptrWidth bits) // page pointer in storage
//   val hashVal = Bits(conf.hashValWidth bits)
// }

// case class HashTableConfig (hashValWidth: Int = 256, ptrWidth: Int = 64, hashTabSize: Int = (1<<20), bucketSize: Int = 256) {
...
// case class HashTabIO(conf: HashTableConfig) extends Bundle {
//   val initEn = in Bool()
